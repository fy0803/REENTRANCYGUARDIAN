...
interface ILendingCallback39 {
    function onCollateralExit39() external;
}

contract RORCollateralIndex39 {
    ...
    function exit(uint256 shares) external {
        ...
        totalShares -= shares;
        ILendingCallback39(msg.sender).onCollateralExit39();
        totalCollateral -= shares;
    }
}

contract RORBorrowMarket39 {
    RORCollateralIndex39 public immutable index;
    mapping(address => uint256) public debt;

    constructor(RORCollateralIndex39 index_) {
        index = index_;
    }
