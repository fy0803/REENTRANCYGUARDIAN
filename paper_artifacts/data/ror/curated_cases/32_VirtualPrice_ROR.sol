...
interface IVirtualPriceCallback32 {
    function onRemoveLiquidity32() external;
}

contract RORCurvePool32 {
    ...
    function removeLiquidity(uint256 lpAmount) external {
        ...
        IVirtualPriceCallback32(msg.sender).onRemoveLiquidity32();
        balanceA -= lpAmount;
        balanceB -= lpAmount;
    }
}

contract RORCurveBorrowMarket32 {
    RORCurvePool32 public immutable pool;
    mapping(address => uint256) public minted;

    constructor(RORCurvePool32 pool_) {
        pool = pool_;
    }
