...
interface ICallback31 {
    function onCallback31() external;
}

contract RORShareVault31 {
    ...
    function withdraw(uint256 shareAmount) external {
        ...
        ICallback31(msg.sender).onCallback31();
        totalAssets -= assets;
    }
}

contract RORShareLender31 {
    RORShareVault31 public immutable vault;
    mapping(address => uint256) public debt;

    constructor(RORShareVault31 vault_) {
        vault = vault_;
    }
