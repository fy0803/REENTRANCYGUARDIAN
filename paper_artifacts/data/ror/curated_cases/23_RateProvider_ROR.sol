...
interface IRateCallback23 {
    function onUnwrap23() external;
}

contract RORRateProviderToken23 {
    ...
    function unwrap(uint256 shareAmount) external {
        ...
        IRateCallback23(msg.sender).onUnwrap23();
        backingAssets -= shareAmount;
    }
}

contract RORRateBasedVault23 {
    RORRateProviderToken23 public immutable token;
    mapping(address => uint256) public credit;

    constructor(RORRateProviderToken23 token_) {
        token = token_;
    }
