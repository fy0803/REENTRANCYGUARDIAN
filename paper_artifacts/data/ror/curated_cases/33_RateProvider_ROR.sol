...
interface IRateCallback33 {
    function onUnwrap33() external;
}

contract RORRateProviderToken33 {
    ...
    function unwrap(uint256 shareAmount) external {
        ...
        IRateCallback33(msg.sender).onUnwrap33();
        backingAssets -= shareAmount;
    }
}

contract RORRateBasedVault33 {
    RORRateProviderToken33 public immutable token;
    mapping(address => uint256) public credit;

    constructor(RORRateProviderToken33 token_) {
        token = token_;
    }
